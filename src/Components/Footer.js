...
// function Footer() {
//   return (
//     <div className='bg-gray-600 text-3xl text-white p-7 mt-5 text-center'>
//     Footer:
//         </div>
//   )
// }
...
const followLinks=[
  ...
  {
    display:'Github',
    url:'https://github.com/rathoursuryanshu10'
  },
  {
    display:'Instagram',
    url:'#'
              ...
              <i className="ri-pantone-line"></i> EnlightenHub.
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <Link to="https://github.com/rathoursuryanshu10" className="text-white">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
